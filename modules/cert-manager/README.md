...
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | Cert Manager Version | `string` | `"v1.20.2"` | no |
...
| <a name="input_trust_manager_version"></a> [trust\_manager\_version](#input\_trust\_manager\_version) | Trust Manager Version | `string` | `"0.22.1"` | no |
