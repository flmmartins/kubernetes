...
| <a name="input_operator_cpu_request"></a> [operator\_cpu\_request](#input\_operator\_cpu\_request) | Operator CPU Request | `string` | `"50m"` | no |
